...
def test_no_metrics_in_config_case():
    ...
    measurement = 'cpu'
    assert get_values_per_measurement(measurement, config_file, logger) is False
...
def test_metrics_present_in_config_case():
    ...
    measurement = 'cpu'
    assert get_values_per_measurement(measurement, config_file, logger) == ['usage_system', 'usage_guest', 'usage_idle']
